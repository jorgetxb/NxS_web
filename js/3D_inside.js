...
loader6.load("../resourses/3D/mult.gltf", function(gltf6) {
    //
...
let video4 = document.getElementById('mult');
...
window.addEventListener("click", (event) => {
    ...
    let examples3 = document.querySelector('#examples-av');
