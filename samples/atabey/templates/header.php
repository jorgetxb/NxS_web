...
<head>
    ...
    <script src="./app/ecological_footprint.js"></script>
    <script src="./app/reforest.js"></script>
    <!-- <script src="./app/graphs.js"></script> -->
    <script src="./app/scripts.js"></script>


    <title>Fundation Atabey</title>
</head>
...
<body>
    ...
    <div class="barra">
        <div class="contenedor navegacion">
            <div class="logo-mobmenu">
                <div class="logo2">
                    <a href="index.php">
                        <img class="isotipo" src="./src/Logo3.svg" alt="">
                    </a>
                </div>
                <a href="index.php">
            ...
            <nav class="navegacion-principal">
                <a href="https://centroatabey.org/">Home</a>
